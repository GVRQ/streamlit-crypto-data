...
st.markdown('Data is provided by the the CoinCaps API. Available crypto coins: Bitcoin, Ethereum, Bitcoin-Cash, EOS, Stellar, Litecoin, Cardano, Tether, IOTA, TRON")
